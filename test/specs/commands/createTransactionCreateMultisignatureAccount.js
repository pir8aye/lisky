															...
															Given(
																...
																() => {
																	When(
																		...
																		() => {
																			Then(
																				'it should reject with message "Lifetime must be an integer."',
										...
										() => {
															...
															Given(
																...
																() => {
																	When(
																		...
																		() => {
																			Then(
																				'it should reject with message "Minimum number of signatures must be an integer."',
																				then.itShouldRejectWithMessage,
																			);
																		},
																	);
											...
											Given(
												...
												() => {
															...
															Given(
																...
																() => {
																	When(
																		...
																		() => {
																			Then(
																				'it should reject with message "Error processing public key +215b667a32a5cd51a94c9c2046c11fffb08c65748febec099451e3b164452bca: Invalid hex string."',
																				then.itShouldRejectWithMessage,
																			);
																		},
																	);
													...
													Given(
														'a keysgroup with keys "215b667a32a5cd51a94c9c2046c11fffb08c65748febec099451e3b164452b"',
														given.aKeysgroupWithKeys,
														() => {
															Given(
																'an empty options object',
																...
																() => {
																	When(
																		...
																		() => {
																			Then(
																				'it should reject with message "Public key 215b667a32a5cd51a94c9c2046c11fffb08c65748febec099451e3b164452b length differs from the expected 64 hex characters for a public key."',
																				then.itShouldRejectWithMessage,
																			);
																		},
																	);
													...
													Given(
														...
														() => {
															Given(
																...
																() => {
																	Given(
																		'an error "Unknown data source type. Must be one of `file`, or `stdin`." occurs retrieving the inputs from their sources',
