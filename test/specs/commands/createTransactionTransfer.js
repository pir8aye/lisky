												...
												Given(
													...
													() => {
														When(
															...
															() => {
																Then(
																	'it should reject with message "Amount must be a number with no more than 8 decimal places."',
											...
											Given(
												...
												() => {
													When(
														...
														() => {
															Then(
																'it should reject with message "1234567890LL is not a valid address."',
																then.itShouldRejectWithMessage,
															);
														},
													);
