...
describe('sign message command', () => {
	...
	describe('Given a Vorpal instance with a UI and an active command that can prompt', () => {
		...
		describe('Given a crypto instance has been initialised', () => {
			...
			describe('Given an action "sign message"', () => {
					...
					describe('Given a message "Some secret message\nthat spans multiple\n lines"', () => {
						...
						describe('Given the passphrase is provided via the prompt', () => {
							...
							describe('Given an empty options object', () => {
								...
								describe('When the action is called with the message and the options', () => {
									beforeEach(when.theActionIsCalledWithTheMessageAndTheOptions);
									...
									it('Then it should sign the message with the passphrase', then.itShouldSignTheMessageWithThePassphrase);
									it('Then it should resolve to the result of signing the message', then.itShouldResolveToTheResultOfSigningTheMessage);
								});
							});
