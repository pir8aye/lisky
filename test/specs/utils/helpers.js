		...
		Given(
			...
			() => {
				When(
					...
					() => {
						Then(
							'it should throw error "Lifetime must be an integer."',
		...
		Given(
			...
			() => {
				When(
					...
					() => {
						Then(
							'it should throw error "Minimum number of signatures must be an integer."',
							then.itShouldThrowError,
						);
					},
				);
	...
	describe('#validateAddress', () => {
		...
		Given('an invalid address "1234567890LL"', given.anInvalidAddress, () => {
			When(
				...
				() => {
					Then(
						'it should throw error "1234567890LL is not a valid address."',
						then.itShouldThrowError,
					);
				},
			);
		...
		Given('an invalid address "L"', given.anInvalidAddress, () => {
			When(
				...
				() => {
					Then(
						'it should throw error "L is not a valid address."',
						then.itShouldThrowError,
					);
				},
			);
		...
		Given(
			...
			() => {
				When(
					...
					() => {
						Then(
							'it should throw error "0123456789101112131415L is not a valid address."',
							then.itShouldThrowError,
						);
					},
				);
	...
	describe('#validateAmount', () => {
		...
		Given('an invalid amount "abcedf"', given.anInvalidAmount, () => {
			When(
				...
				() => {
					Then(
						'it should throw the error "Amount must be a number with no more than 8 decimal places."',
						then.itShouldThrowError,
					);
				},
			);
